 ...
 *
 * Run with: pnpm e2e:ui -- --host http://localhost:PORT domain-admin-component-visual
 * Update snapshots:
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/domain-admin-component-visual.spec.ts-snapshots/
 *   2. Generate new: pnpm e2e:ui -- --host http://localhost:PORT --update-snapshots domain-admin-component-visual
 */
