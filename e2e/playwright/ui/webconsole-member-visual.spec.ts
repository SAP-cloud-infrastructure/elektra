 ...
 *
 * Run with: pnpm e2e:ui -- --host http://localhost:PORT webconsole-member-visual
 * Update snapshots:
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/webconsole-member-visual.spec.ts-snapshots/
 *   2. Generate new: pnpm e2e:ui -- --host http://localhost:PORT --update-snapshots webconsole-member-visual
 */
