 ...
 *
 * Run with: pnpm e2e:playwright:ui -- --host http://localhost:PORT shared-filesystem-admin-component-visual
 * Update snapshots: 
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/shared-filesystem-admin-component-visual.spec.ts-snapshots/ 
 *   2. Generate new: pnpm e2e:playwright:ui -- --host http://localhost:PORT --update-snapshots shared-filesystem-admin-component-visual
 */
