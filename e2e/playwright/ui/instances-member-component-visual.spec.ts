 ...
 *
 * Run with: pnpm e2e:ui -- --host http://localhost:PORT instances-member-component-visual
 * Update snapshots:
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/instances-member-component-visual.spec.ts-snapshots/
 *   2. Generate new: pnpm e2e:ui -- --host http://localhost:PORT --update-snapshots instances-member-component-visual
 */
