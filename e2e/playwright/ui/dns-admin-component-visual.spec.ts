 ...
 *
 * Run with: pnpm e2e:playwright:ui -- --host http://localhost:PORT dns-admin-component-visual
 * Update snapshots: 
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/dns-admin-component-visual.spec.ts-snapshots/ 
 *   2. Generate new: pnpm e2e:playwright:ui -- --host http://localhost:PORT --update-snapshots dns-admin-component-visual
 */
