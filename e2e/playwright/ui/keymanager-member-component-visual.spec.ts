 ...
 *
 * Run with: pnpm e2e:ui -- --host http://localhost:PORT keymanager-member-component-visual
 * Update snapshots:
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/keymanager-member-component-visual.spec.ts-snapshots/
 *   2. Generate new: pnpm e2e:ui -- --host http://localhost:PORT --update-snapshots keymanager-member-component-visual
 */
