 ...
 *
 * Run with: pnpm e2e:ui -- --host http://localhost:PORT networking-admin-component-visual
 * Update snapshots:
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/networking-admin-component-visual.spec.ts-snapshots/
 *   2. Generate new: pnpm e2e:ui -- --host http://localhost:PORT --update-snapshots networking-admin-component-visual
 */
