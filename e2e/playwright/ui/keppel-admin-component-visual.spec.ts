 ...
 *
 * Run with: pnpm e2e:ui -- --host http://localhost:PORT keppel-admin-component-visual
 * Update snapshots:
 *   1. Delete old snapshots: rm -rf e2e/playwright/ui/keppel-admin-component-visual.spec.ts-snapshots/
 *   2. Generate new: pnpm e2e:ui -- --host http://localhost:PORT --update-snapshots keppel-admin-component-visual
 */
