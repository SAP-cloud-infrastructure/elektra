...
threads_count = Integer(ENV["MAX_THREADS"] || 10) # maximum threads that can be used
min_threads = Integer(ENV["MIN_THREADS"] || 2)  # minimum threads that are always available
