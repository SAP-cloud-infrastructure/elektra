...
describe("HeadingInfo", () => {
  it("renders with collapsed instructions by default", () => {
    render(<HeadingInfo />)
    const button = screen.getByRole("button", { name: /show managing your clusters with kubectl/i })
  ...
  it("shows instructions when button is clicked", async () => {
    ...
    expect(screen.getByText(/hide managing your clusters with kubectl/i)).toBeInTheDocument()
