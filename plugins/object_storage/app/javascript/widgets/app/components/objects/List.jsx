...
const Objects = () => {
  ...
  const [deleteFolder, cancelDeleteFolder] = React.useMemo(() => {
    ...
    const action = (name, options = {}) => {
      confirm(`This folder will be irrevocably deleted. If the folder contains more than 100,000 objects, for performance reasons and safety considerations, please delete it using the WebShell or your CLI with "swift delete ${options.containerName || containerName} --recursive ${name}"`, {
