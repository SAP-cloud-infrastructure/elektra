...
- Name: visual/styleguide/modals.spec.ts >> Styleguide - Modals >> Modal with Validation Errors
- Location: tests/visual/styleguide/modals.spec.ts:81:7
...
Call log:
  - waiting for locator('button:has-text("Open Modal with Validation")')
