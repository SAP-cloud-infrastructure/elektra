...
gem 'rails', '8.1.3.1'
# Pin json to 2.x: json 3.0 changed JSON.parse to accept only one positional
# argument, which breaks ActiveSupport 8.1.3.1's JSON.decode (calls JSON.parse(json, options)).
gem 'json', '~> 2.21'
