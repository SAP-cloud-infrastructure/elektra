...
- Name: smoke/homepage.spec.ts >> Homepage >> should load successfully
- Location: tests/smoke/homepage.spec.ts:8:7
...
Expected pattern: /Elektra/i
Received string:  "SAP Cloud Infrastructure qa-de-1"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    9 × unexpected value "SAP Cloud Infrastructure qa-de-1"
